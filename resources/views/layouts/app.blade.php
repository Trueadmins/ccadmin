            ...
            <div class="container max-w-7xl py-1">
                <nav class="flex flex-col lg:flex-row gap-3 items-center justify-between">
                    ...
                    @guest
                        ...
                        {{--                            @endif--}}
                    @else
                        <a class="text-sm bg-primary inline-flex items-center gap-1 text-white font-bold capitalize px-4 py-1.5 rounded-full shadow hover:bg-secondary justify-center"
                           href="/shipment/new">
                            Book Parcel <i class="iconify" data-icon="mdi-package-variant-plus"></i>
                        </a>
